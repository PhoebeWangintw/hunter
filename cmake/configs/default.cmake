...
hunter_default_version(ARPACK-NG VERSION 3.5.0-p5)
...
hunter_default_version(Beast VERSION hunter-189-hf1)
...
hunter_default_version(GnuPlotCpp VERSION 1.0)
...
hunter_default_version(armadillo VERSION 8.200.x-p8)
...
hunter_default_version(cppzmq VERSION v4.2.2_ht_beta)
...
hunter_default_version(cvplot VERSION 0.0.3-p1)
...
hunter_default_version(hdf5 VERSION 1.10.5-h0)
...
hunter_default_version(lehrfempp VERSION 0.7.20)
...
hunter_default_version(mkl-cmake VERSION 20190502-p0)
hunter_default_version(mkldnn VERSION 0.19-p0)
hunter_default_version(mlpack VERSION 2.2.5-p1)
...
if(MSVC)
  if(MSVC_VERSION LESS 1916)
    hunter_default_version(range-v3 VERSION vcpkg5-p)
      ...
      #hunter_default_version(range-v3 VERSION 0.9.1)
